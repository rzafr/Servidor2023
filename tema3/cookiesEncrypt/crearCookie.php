...
if ($_GET) {
    ...
    if (isset($_COOKIE['servidor'])) {
        ...
        // Aquí desdencriptamos los datos--------------------------------------------------------------
    ...
    setcookie('servidor', strval($gustosEncrypt), time()+60*30, "/tema3/cookiesEncrypt", "localhost", false, true);
