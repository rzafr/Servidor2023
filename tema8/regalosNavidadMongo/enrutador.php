    ...
    if ($_REQUEST) {
        if (isset($_REQUEST['accion'])) {
            ...
            if ($_REQUEST['accion'] == "nuevoRegalo") {
                ...
                $regalo = new Regalo($id_usuario, $nombre, $destinatario, $precio, $estado, $year);

                ControladorRegalo::nuevoRegalo($regalo);
            }
            ...
            if ($_REQUEST['accion'] == "nuevoEnlace") {
                ...
                $enlace = new Enlace($id_regalo, $nombre, $enlace, $precio, $imagen, $prioridad);

                ControladorEnlace::nuevoEnlace($enlace);
            }
